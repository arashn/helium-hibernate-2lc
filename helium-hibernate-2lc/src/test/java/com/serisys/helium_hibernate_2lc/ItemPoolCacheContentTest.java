...
import com.serisys.helium.jcache.util.ItemPool;

@RunWith(JUnit4.class)
@FixMethodOrder(MethodSorters.NAME_ASCENDING)
public class ItemPoolCacheContentTest extends CacheContentTest {
	@BeforeClass
	...
	public ItemPoolCacheContentTest() {
