...
public class UpdatedExpiryTest extends CacheExpiryTest {
	...
	public static void setUp() {
		...
		config.setExpiryPolicyFactory(ModifiedExpiryPolicy.factoryOf(EXPIRY));
	...
	public void t0002_get_expiry_update() {
		...
		sleep(SECOND_HALF_WAIT);
		assertEquals(ualue,cache.get(key)); // this is the method we are testing for expiry
		sleep(FIRST_HALF_WAIT);
